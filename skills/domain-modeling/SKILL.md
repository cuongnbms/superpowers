...
What typically passes all three:
...
Write it in the format in [ADR-FORMAT.md](./ADR-FORMAT.md), which also covers how to append updates and how to supersede an earlier ADR.
